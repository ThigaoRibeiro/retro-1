<?php
    ...
    try{     
        ...
        $sql_func ="INSERT INTO cliente(nome, email) VALUES (:f,:e)";
        ...
        $sql_func_tel = "INSERT INTO cliente_telefone(tel_01, tel_02) VALUES (:t1, :t2)";
        ...
        $sql_func_endereco="INSERT INTO cliente_endereco (endereco_rua, endereco_bairro,
